...
```{r}
linear_regression(mtcars_mpg,mtcars_covariates,intercept = F,ss = T)$ss
...
```{r}
linear_regression(mtcars_mpg,mtcars_covariates,intercept = F,t_test=T)$t_test
...
```{r}
linear_regression(mtcars_mpg,mtcars_covariates,intercept = F,f_test=T)$f_test
